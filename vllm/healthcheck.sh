#!/usr/bin/env bash
# =============================================================================
# healthcheck.sh — In-container healthcheck for the vLLM server
#
# Verifies:
#   1. The /health endpoint responds with HTTP 200
#   2. The /v1/models endpoint responds and lists at least one model
#
# Used as the Docker/Podman HEALTHCHECK command inside the vLLM container.
...
# Verify the response contains model data using python3 (available in vllm image)
